...
public class EGraduacao extends Estudante{
    ...
    // ================================= Construtores:
    public EGraduacao(CPF cpf, String nome, LocalDate dNascimento, String codMatricula, Double cra, String estagioSuperv) {
        super(cpf, nome, dNascimento, codMatricula, cra);

        this.estagioSuperv = estagioSuperv;
    }

    public EGraduacao() {super();}


    // ================================= Getters e Setters
    public String getEstagio() { return estagioSuperv; }
